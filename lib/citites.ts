...
> = {
  ...
  lon: {
    ...
    monthly: [59.9,55.0,48.1,56.7,57.9,62.9,60.0,66.1,54.1,64.5,68.1,62.5],
  },
  ber: {
    coords: [52.51874, 13.40802],
    // prettier-ignore
    monthly: [56.2, 47.2, 53.1, 42.4, 60.4, 64.1, 82.5, 62.6, 57.2, 50.7, 47.6, 52.7],
  },
};
